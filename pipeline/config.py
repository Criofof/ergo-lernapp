...
SUBJECTS = [
  ...
  # ---- FG 2 (Prüfung 05.08.) ----  (Päd+Psych teilen einen Kursordner)
  dict(slug="psychologie", gruppe="fg2", render_unit="paed-psych",
       folder=_f(FG2, "Fach = Pädagogik und Psychologie"),
       heading="Psychologie:"),
  dict(slug="paedagogik", gruppe="fg2", render_unit="paed-psych",
       folder=_f(FG2, "Fach = Pädagogik und Psychologie"),
       heading="Pädagogik:"),
  ...
  dict(slug="skl-orthopaedie", gruppe="fg1", render_unit="ortho-rheuma",
       folder=_f(FG1, "Fach = SKL Orthopädie und Rheumatologie"),
       heading="SKL - Orthopädie:"),
  dict(slug="skl-rheumatologie", gruppe="fg1", render_unit="ortho-rheuma",
       folder=_f(FG1, "Fach = SKL Orthopädie und Rheumatologie"),
       heading="SKL - Rheumatologie:"),
